    ...
    <div className="flex items-center gap-5">
      {socials.map((s) => (
        <a
          ...
          style={{ color: 'var(--text-muted)', textDecoration: 'none', fontSize: '0.82rem' }}
      ...
      <div className="container relative">
        ...
        >
          <div
            ...
            style={{ width: 160, height: 160, border: '1.5px solid var(--border)' }}
          >
            <img
              src={abrahamImg}
              alt="Abraham Markus"
              ...
              onError={(e) => {
                ...
                e.target.parentElement.style.background = 'var(--bg-subtle)'
              }}
            />
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            />
            Available for Senior &amp; Lead Full-Stack Roles — Remote or On-site, Nigeria
          </span>
        </motion.div>
        ...
        >
          ...
          {/* TODO: replace cvUrl in data/content.js with real hosted PDF (Google Drive, Dropbox, etc.) */}
          <a
            href={meta.cvUrl}
        ...
        >
          {metaCols.map((col) => (
            <motion.div
              key={col.label}
              variants={metaItem}
              style={{ padding: '20px 16px 20px 0', borderRight: '1px solid var(--border)' }}
            ...
            >
              ...
              <div
                style={{
                  fontSize: '0.875rem',
                  lineHeight: 1.5,
                  fontWeight: col.isAvailable ? 600 : 500,
                  color: col.isAvailable ? '#4ADE80' : 'var(--text-primary)',
                  display: col.isAvailable ? 'flex' : undefined,
                  alignItems: col.isAvailable ? 'center' : undefined,
                  gap: col.isAvailable ? 6 : undefined,
                }}
              >
                {col.isAvailable && (
                  <span
